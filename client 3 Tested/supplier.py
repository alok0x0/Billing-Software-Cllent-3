...
class supplierClass:
    def __init__(self,root):
        ...
        btn_add=Button(self.root,text="Show All",command=self.show,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=180,y=410,width=110,height=35)
        #===Employee Details===
